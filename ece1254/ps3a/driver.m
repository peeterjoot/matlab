function driver( what, withBE )
   ...
   if ( what == 1 )
      ...
      if ( 1 )
         ...
         ylabel( 'Voltages (V)' ) ;
         legend( labels ) ;
         savePath = sprintf( 'ps3a%sFig%d.%s', 'ErrorBE', 5, fileExtension ) ;
         savePlot( f, savePath ) ;
      end
      ...
      if ( 1 )
         ...
         savePath = sprintf( 'ps3a%sFig%d.%s', 'ErrorTR', 6, fileExtension ) ;
         savePlot( f2, savePath ) ;
      end
      ...
      if ( 1 )
         ...
         savePath = sprintf( 'ps3a%sFig%d.%s', 'LogLogError', 7, fileExtension ) ;
         savePlot( f3, savePath ) ;
      end
   ...
   elseif ( what == 2 )
      ...
      savePath = sprintf( 'ps3a%sFig%d.%s', methodStr, 2 + withTR * 2, fileExtension ) ;
      savePlot( f, savePath ) ;
   else
      f = figure ;
      hold on ;
      ...
      savePath = sprintf( 'ps3a%sFig%d.%s', methodStr, 1 + withTR * 2, fileExtension ) ;
      savePlot( f, savePath ) ;
   end
